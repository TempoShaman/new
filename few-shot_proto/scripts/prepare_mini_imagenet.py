...
import shutil
import os
sys.path.append(r"C:\Users\olive\Documents\oskarknagg")
...
classes = []
for root, _, files in os.walk(DATA_PATH + '/data/miniImageNet/images/'):
    #print(root)
    for f in files:
        print(f)
        if f.endswith('.jpg'):
...
print("___________________")
print("eval classes:", evaluation_classes)
print("bg classes:", background_classes)
print("___________________")
