...
callbacks = [
    ...
    ModelCheckpoint(
        filepath= r'C:\Users\olive\Documents\few-shot\datasets\models\matching_nets\matching.t7',
    ...
    CSVLogger(r'C:\Users\olive\Documents\few-shot\datasets\logs\matching_nets\matching.csv'),
]
