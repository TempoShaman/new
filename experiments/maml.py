...
callbacks = [
    ...
    ModelCheckpoint(
        filepath= r'C:\Users\olive\Documents\few-shot\datasets\models\maml\maml.t7',
        monitor=f'val_{args.n}-shot_{args.k}-way_acc'
    ),
    ReduceLROnPlateau(patience=10, factor=0.5, monitor=f'val_loss'),
    CSVLogger(r'C:\Users\olive\Documents\few-shot\datasets\models\\maml\{param_str}.csv'),
]
